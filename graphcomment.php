 ...
 */
define('GRAPHCOMMENT_URL', 'https://graphcomment.com');
...
define('API_URL_SETUP_SYNC', constant('API_URL') . '/website/sync_setup');
define('API_URL_SETUP_NOTIF', constant('API_URL') . '/website/notif_setup');
define('ADMIN_URL', constant('GRAPHCOMMENT_URL') . '/admin');
define('ADMIN_URL_LOGIN', constant('ADMIN_URL') . '/#/login');
define('REGISTER_URL', constant('ADMIN_URL') . '/#/register');
define('API_URL_IMPORT', constant('API_URL') . '/website/import');
define('API_URL_IMPORT_INIT', constant('API_URL') . '/website/import/init');
define('API_URL_IMPORT_RESTART', constant('API_URL') . '/website/import/restart');
define('API_URL_IMPORT_STOP', constant('API_URL') . '/website/import/cancel');
define('API_URL_IMPORT_FINISH', constant('API_URL') . '/website/import/end');
 ...
 */
function _graphcomment_enqueue_style() {
  wp_enqueue_style('gc-style', plugins_url('/theme/css/style.css', __FILE__));
}
...
add_action('wp_enqueue_scripts', '_graphcomment_enqueue_style');
