...
class GcCommentBuilder
{
  ...
  {
    return !isset($this->comment->parent) || $this->comment->parent === null;
  }
  ...
  public function updateCommentInDatabase()
  {
    ...
    $data = array(
      ...
      'comment_author_email' => ($this->comment->author->email ? $this->comment->author->email : ''),
    ...
    if ($up_res === false) {
      GcLogger::getLogger()
          ->error('GcParamsService::updateCommentInDatabase() - Update error ( request: ' . $this->toString() . ' )');
      GcLogger::getLogger()
          ->error('GcParamsService::updateCommentInDatabase() - Last SQL error (' . $wpdb->last_error . ' )');
      return false;
    }
  ...
  public function insertCommentInDatabase()
  {
    ...
    $data = array(
        ...
        'comment_author' => $this->comment->author->username,
        'comment_author_email' => ($this->comment->author->email ? $this->comment->author->email : ''),
